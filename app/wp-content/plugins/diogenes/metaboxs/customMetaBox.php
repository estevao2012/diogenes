...
*	How It Works 
    ...
    $opcoes =  array(
      ...
      'fields' => array(
            array(
              'name' => 'Observação',
              'desc' => 'Observação para os resultados do tratamento.',
              'id' => 'observacao',
              'type' => 'textarea',
              'default' => ''
            )
...
class CustomMetaBox
{
	...
	{ 
		add_action('admin_menu', array($this,'plib_add_box'));  
		add_action('save_post', array($this, 'plib_save_data'));
		$this->meta_box = $args;
	}
